...
module.exports = (db) => {
  ...
  router.post("/", (req, res) => {
    console.log('afbsjd');
    res.send(req.body)
    const values = [req.body.title, req.body.price, req.body.description, req.body.photo, req.body.country, req.body.street, req.body.city, req.body.province, req.body.post_code]
